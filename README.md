...
[![Go Reference](https://pkg.go.dev/badge/golang.org/x/example.svg)](https://pkg.go.dev/github.com/autheona/golog)
...
```bash
go get -u github.com/autheona/golog
```
